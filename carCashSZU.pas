...
procedure TcarCashSZ_F.btn_tjClick(Sender: TObject);
var
  sql: string;
...
procedure TcarCashSZ_F.FormCreate(Sender: TObject);
begin
  Self.Position := poScreenCenter;
  Self.WindowState := wsMaximized; // 最大化
end;

procedure TcarCashSZ_F.FormShow(Sender: TObject);
begin
...
procedure TcarCashSZ_F.timer_disDBConTimer(Sender: TObject);
begin
  // TODO 断开数据库连接
